#!/usr/bin/env python
"""
run_rot6_closed_loop.py -- the Decision-10 closed-loop check for the rotation
round-6 composition family: a paired-stream engine run with the rotation's engine-produced state
...
def run(args) -> int:
    ...
    meta = {
        ...
        "round": "rotation round 6 (docs/models/rotation/experiments.md section 14.9)",
        "created_at": datetime.now(UTC).isoformat(),
        "rotation_arm": args.arm, "round4_variant": args.round4_arm,
        "round5_variant": args.round5_arm, "round6_variant": args.round6_arm, "refit_without_state": bool(args.nostate),
...
def main() -> int:
    ...
    ap.add_argument("--arm", default="round6",
                    choices=["reference", "round4", "round5", "round6"])
